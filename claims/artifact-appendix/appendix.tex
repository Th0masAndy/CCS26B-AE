...
Bash, CMake, Git, Python~3, and the system packages listed in
\path{scripts/build/run.sh} are required. Internet access is needed for a fresh build. Result processing and
...
\emph{10 person-minutes + 3--4 compute-hours; 80\,GiB RAM recommended.}
...
in both \path{summary.md} and \path{paper-comparison.md}, and one
overview SVG, \path{runtime-comparison.svg}. Its panels cover all set sizes, dimensions,
and modes. The terminal reports
...
\emph{10 person-minutes; 2--3 hours compute; 256\,GiB RAM recommended.}
...
in each summary/comparison Markdown table and one overview SVG covering all metrics,
